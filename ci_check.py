...
SOURCE_COMMANDS = [
    ...
    ['python3', '-m', 'coverage', 'run', '--parallel-mode', '--source=src/excel_ir_mvp', '-m', 'unittest',
     ...
     'tests.test_excel_ir_mvp.ExcelIRMVPTests.test_alpha17_fast_parse_profile_and_no_legacy_top_level_api'],
...
INSTALLED_COMMANDS = [
    ...
    ['excel-ir', 'parse', 'tests/fixtures/complex_report.xlsx', 'ci_installed_selected.ir.json', '--sheet', '经营驾驶舱'],
    ['excel-ir', 'parse', 'tests/fixtures/complex_report.xlsx', 'ci_installed_fast.ir.json', '--fast'],
    ['excel-ir', 'rebuild', 'ci_installed_selected.ir.json', 'ci_installed_selected.xlsx', '--sheet', '经营驾驶舱'],
